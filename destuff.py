...
class MainWindow(tk.Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.directory_ = settings['script-directory']
        self.dark_ = settings['colors']['dark']
        self.light_ = settings['colors']['light']
        self.font_ = settings['font']
        self.button_ = {'relief': 'groove', 'height': 2}
        self.button_grid_ = {'sticky': 'nsew'}

        self.config(bg=self.light_)
        ...
        self.btn_frame = tk.Frame(self, bg=self.light_, padx=10, pady=10)
        ...
        self.btn_update_global = tk.Button(
            ...
            command=lambda: update_global(self.master.settings['script-directory']), font=self.font_, **self.button_
        )
        self.btn_update_global.grid(row=0, column=0, **self.button_grid_)

        self.msg_rebuild = tk.Label(
            self.btn_frame, text='* * * Rebuild dcx files before updating sdat files * * *',
            fg=self.dark_, bg=self.light_, font='Consolas 11 bold'
        )
    ...
    # -----------------------------------------------------
        ...
        btn = {'relief': 'groove'}
        self.search_frame = tk.Frame(self, bg=self.light_)
        ...
        self.search_label = tk.Label(
            ...
            bg=self.light_, fg=self.dark_, font=self.font_
        )
        ...
        self.btn_search = tk.Button(
            ...
            command=self.btn_search_click, font=self.font_, **btn
        )
        ...
        self.checkbox_case_sensitive = tk.Checkbutton(
            ...
            variable=self.var_case_sensitive, bg=self.light_, fg=self.dark_, font=self.font_,
        ...
        self.checkbox_regex = tk.Checkbutton(
            ...
            variable=self.var_regex, bg=self.light_, fg=self.dark_, font=self.font_,
            command=self.checkbox_click
        )
    ...
    # ---------------------------------------------------------------
        ...
        list_style = {'font': self.font_, 'relief': 'groove'}

        self.found = []

        self.lists_frame = tk.Frame(self, bg=self.light_)
        ...
        self.lb_previous_searches = ScrollbarListFrame(
            self.lists_frame, bg=self.light_, label='Previous search terms',
        ...
        self.lb_files_found = ScrollbarListFrame(
            self.lists_frame, bg=self.light_, label='Files found',
            list_style=list_style
        )
        self.lb_files_found.grid(row=0, column=1, sticky='nsew')
        dir_ = settings['script-directory']
        ...
        self.lb_file_context = ScrollbarListFrame(
            self.lists_frame, bg=self.light_, label='File context',
            list_style=list_style
        )
